...
class UpyunAction extends UserAction{
	...
	public function upload(){
		...
		if ($this->upload_type=='upyun'){
			...
			$options['return-url'] = C('site_url').'/index.php?g=Wap&m=Upyun&a=uploadReturn'; /// 页面跳转型回调地址
			...
			if (IS_POST){
				...
				echo '<script>location.href="'.C('site_url').'/index.php?g=Wap&m=Upyun&a=upload&error='.$return['error'].'&msg='.$return['msg'].'";</script>';
			}else{
