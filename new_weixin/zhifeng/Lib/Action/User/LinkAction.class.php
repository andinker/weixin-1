...
class LinkAction extends UserAction
{
    ...
    public function _initialize()
    {
        ...
        $this->modules = array(
		'Home' => '首页', 'Classify' => '网站分类', 'Img' => '图文回复', 'Company' => 'LBS信息', 'Adma' => 'DIY宣传页', 'Photo' => '相册', 'Selfform' => '万能表单','Host' => '商家订单', 
		'Groupon' => '团购', 'Shop' => '商城', 'Dining' => '订餐', 'Wedding' => '婚庆喜帖', 'Vote' => '投票','Panorama' => '全景', 'Lottery' => '大转盘', 'Guajiang' => '刮刮卡', 'Zadan' => '砸金蛋',
		'Liuyan' => '留言', 'Coupon' => '优惠券', 'MemberCard' => '会员卡','Yuyue' => '微预约', 'Diaoyan' => '微调研','Forum'=>'微社区','Recommend'=>'微推荐','Scoregift'=>'积分换礼','Tools'=>'工具大全',
		'Estate' => '微房产', 'Jiudian' => '微酒店', 'Yiliao' => '微医疗','Zuche'=>'微租车','Car'=>'微汽车','Lvyou'=>'微旅游','Renovation'=>'微装修','Flower'=>'微花店','ZhengWu'=>'微政务',
		'Jianshen'=>'微健身','Jiaoyu'=>'微教育','Jiuba'=>'微酒吧','Ktv'=>'微Ktv','Meirong'=>'微美容','Market'=>'微商圈'
		);
    }
    ...
    {
        return array(
			array('module' => 'Market', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Market&a=index&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Market'], 'sub' => 1, 'canselected' => 1, 'linkurl' => '', 'keyword' => '微商圈', 'askeyword' => 1),
			...
			array('module' => 'Renovation', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Renovation&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'name' => $this->modules['Renovation'], 'sub' => 1, 'canselected' => 1, 'linkurl' => '', 'keyword' => '微装修', 'askeyword' => 1),
			array('module' => 'Flower', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Flower&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'name' => $this->modules['Flower'], 'sub' => 1, 'canselected' => 1, 'linkurl' => '', 'keyword' => '微花店', 'askeyword' => 1),
			array('module' => 'ZhengWu', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=ZhengWu&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'name' => $this->modules['ZhengWu'], 'sub' => 1, 'canselected' => 1, 'linkurl' => '', 'keyword' => '微政务', 'askeyword' => 1),			
			...
			array('module' => 'Forum', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Forum&a=index&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Forum'], 'sub' => 0, 'canselected' => 1, 'linkurl' => '', 'keyword' => $this->modules['Forum'], 'askeyword' => 1),
			array('module' => 'Recommend', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Recommend&a=index&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Recommend'], 'sub' => 1, 'canselected' => 1, 'linkurl' => '', 'keyword' => $this->modules['Recommend'], 'askeyword' => 1),
			array('module' => 'Scoregift', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Scoregift&a=index&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Scoregift'], 'sub' => 0, 'canselected' => 1, 'linkurl' => '', 'keyword' => $this->modules['Scoregift'], 'askeyword' => 1),
			array('module' => 'Tools', 'linkcode' => '', 'name' => $this->modules['Tools'], 'sub' => 1, 'canselected' => 0, 'linkurl' => '', 'keyword' => $this->modules['Tools'], 'askeyword' => 1));
    }
	...
	public function Zadan()
    {
        ...
        if ($list) {
            foreach ($list as $item) {
                array_push($items, array('id' => $item['id'], 'name' => $item['title'], 'linkcode' => (('{siteUrl}/index.php?g=Wap&m=Zadan&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&id=') . $item['id'], 'linkurl' => '', 'keyword' => $item['keyword']));
            }
        }
        $this->assign('list', $items);
        $this->assign('page', $show);
    ...
    {
        $moduleName = 'Renovation';
        $this->assign('moduleName', $this->modules[$moduleName]);
        $items = array();
        array_push($items, array('id' => 1, 'name' => '公司介绍', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Renovation&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微装修'));
        array_push($items, array('id' => 2, 'name' => '施工相册', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Renovation&a=album&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微装修'));
        array_push($items, array('id' => 3, 'name' => '案例展示', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Renovation&a=housetype&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微装修'));
        array_push($items, array('id' => 4, 'name' => '会员印象', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Renovation&a=impress&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微装修'));
		array_push($items, array('id' => 5, 'name' => '新闻动态', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Renovation&a=news&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微装修'));
		array_push($items, array('id' => 6, 'name' => '关于我们', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Renovation&a=aboutus&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微装修'));
        $rt = M('Yuyue')->where(array('token' => $this->token,'type'=>'Renovation'))->select();
		foreach($rt as $key=>$vo){
        array_push($items, array('id' => 7+$key, 'name' => $vo['title'], 'linkcode' => ((('{siteUrl}/index.php?g=Wap&m=Yuyue&a=index&id=' . $vo['id']) . '&token=') . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => $vo['keyword']));
        }
		$this->assign('list', $items);
	...
	public function Flower(){
        ...
        $this->assign('moduleName', $this->modules[$moduleName]);
        $items = array();
        array_push($items, array('id' => 1, 'name' => '花店介绍', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Flower&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
        array_push($items, array('id' => 2, 'name' => '花卉相册', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Flower&a=album&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
        array_push($items, array('id' => 3, 'name' => '特色花卉', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Flower&a=housetype&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
        array_push($items, array('id' => 4, 'name' => '会员印象', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Flower&a=impress&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
		array_push($items, array('id' => 5, 'name' => '新闻动态', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Flower&a=news&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
		array_push($items, array('id' => 6, 'name' => '关于我们', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Flower&a=aboutus&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
        $rt = M('Yuyue')->where(array('token' => $this->token,'type'=>'Flower'))->select();
		foreach($rt as $key=>$vo){
        array_push($items, array('id' => 7+$key, 'name' => $vo['title'], 'linkcode' => ((('{siteUrl}/index.php?g=Wap&m=Yuyue&a=index&id=' . $vo['id']) . '&token=') . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => $vo['keyword']));
        }
		$this->assign('list', $items);
	...
	public function ZhengWu()
    {
        ...
        $this->assign('moduleName', $this->modules[$moduleName]);
        $items = array();
        array_push($items, array('id' => 1, 'name' => '政务介绍', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=ZhengWu&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
        array_push($items, array('id' => 2, 'name' => '办公科室', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=ZhengWu&a=album&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
        array_push($items, array('id' => 3, 'name' => '服务类型', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=ZhengWu&a=housetype&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
        array_push($items, array('id' => 4, 'name' => '领导指示', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=ZhengWu&a=impress&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
		array_push($items, array('id' => 5, 'name' => '新闻动态', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=ZhengWu&a=news&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
		array_push($items, array('id' => 6, 'name' => '关于我们', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=ZhengWu&a=aboutus&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微酒吧'));
        $rt = M('Yuyue')->where(array('token' => $this->token,'type'=>'ZhengWu'))->select();
		foreach($rt as $key=>$vo){
        array_push($items, array('id' => 7+$key, 'name' => $vo['title'], 'linkcode' => ((('{siteUrl}/index.php?g=Wap&m=Yuyue&a=index&id=' . $vo['id']) . '&token=') . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => $vo['keyword']));
        }
		$this->assign('list', $items);
	...
	public function Recommend()
    {
        ...
        $this->assign('moduleName', $this->modules[$moduleName]);
        $items = array();
        array_push($items, array('id' => 1, 'name' => '活动列表', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Recommend&a=lists&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微推荐'));
		$rt = M('Recommend')->where(array('token' => $this->token))->select();
		$id=2;
		foreach($rt as $key=>$vo){			
			array_push($items, array('id' => $id, 'name' =>$vo['title'], 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Recommend&a=index&token=' . $this->token) . '&wecha_id={wechat_id}&acid='.$vo['id'].'&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微推荐'));
			array_push($items, array('id' => 1+$id, 'name' =>'填写活动：“'.$vo['title'].'”推荐码', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Recommend&a=recommendRight&token=' . $this->token) . '&wecha_id={wechat_id}&acid='.$vo['id'].'&recoadd=1&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微推荐'));
			$id+=2;
		}
		$this->assign('list', $items);
        $this->display('detail');
	...
	public function Tools(){
        ...
        $show = $Page->show();
        $list = $db->where($where)->limit(($Page->firstRow . ',') . $Page->listRows)->order('sort ASC')->select();
		foreach($list as $key=>$vo){
			array_push($items, array('id' => $key, 'name' =>$vo['name'], 'linkcode' => $vo['url'], 'linkurl' => '', 'keyword' => $vo['name']));
		}
		$this->assign('list', $items);
        $this->assign('page', $show);
        $this->display('detail');
	...
	public function Market()
    {
        ...
        $this->assign('moduleName', $this->modules[$moduleName]);
        $items = array();
        array_push($items, array('id' => 1, 'name' => '商家', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Market&a=tenant&token='.$this->token).'&wecha_id={$wecha_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '商家'));
        array_push($items, array('id' => 2, 'name' => '停车场', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Market&a=park&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '停车场'));
        array_push($items, array('id' => 3, 'name' => '简介', 'linkcode' => ('{siteUrl}/index.php?g=Wap&m=Market&a=intro&token=' . $this->token) . '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '简介'));
        $rt = M('Market_nav')->where(array('token' => $this->token,'is_show'=>'1','is_system'=>'0'))->order('is_system,sort desc')->select();
		foreach($rt as $key=>$vo){
			array_push($items, array('id' => 4+$key, 'name' => $vo['nav_name'], 'linkcode' => $vo['nav_link']. '&wecha_id={wechat_id}&sgssz=mp.weixin.qq.com', 'linkurl' => '', 'keyword' => '微商圈'));
        }
		$this->assign('list', $items);
        $this->display('detail');
    }
