...
INSERT INTO `zfwx_adma` (`id`, `uid`, `token`, `url`, `copyright`, `info`, `title`) VALUES
(1, 32, 'gomoiz1388471186', 'tpl/Home/weimeng/common/css/img/erwei_big.jpg', '© 2014 智风微信版权所有', '微信营销管理平台为个人和企业提供基于微信公众平台的一系列功能，包括智能回复、微信3G网站、互动营销活动，会员管理，在线订单，数据统计等系统功能,带给你全新的微信互动营销体验。', '智风微信营销服务平台');

--
-- 导出表中的数据 `zfwx_dream`
--

INSERT INTO `zfwx_dream` (`id`, `title`, `content`) VALUES
...
--
-- 导出表中的数据 `zfwx_function`
--

INSERT INTO `zfwx_function` (`id`, `gid`, `usenum`, `name`, `funname`, `info`, `isserve`, `status`) VALUES
...
INSERT INTO `zfwx_node` (`id`, `name`, `title`, `status`, `remark`, `pid`, `level`, `data`, `sort`, `display`) VALUES
...
INSERT INTO `zfwx_role` (`id`, `name`, `pid`, `status`, `sort`, `remark`) VALUES
(5, '超级管理员', 0, 1, 0, ''),
(6, '演示组', 0, 1, 0, ''),
(9, '普通会员', 0, 1, 0, '');

--
-- 导出表中的数据 `zfwx_system_info`
--

INSERT INTO `zfwx_system_info` (`lastsqlupdate`, `version`) VALUES
(1381459860, '');
...
INSERT INTO `zfwx_users` (`id`, `gid`, `username`, `password`, `email`, `createtime`, `lasttime`, `status`, `createip`, `lastip`, `diynum`, `activitynum`, `card_num`, `card_create_status`, `wechat_card_num`, `money`, `viptime`, `connectnum`, `lastloginmonth`) VALUES
(32, 4, 'test', '098f6bcd4621d373cade4e832627b4f6', '1@1.com', '1386834191', '1393813834', '1', '127.0.0.1', '127.0.0.1', 0, 0, 0, 0, 3, 0, '1452441600', 0, 3);

--
-- 导出表中的数据 `zfwx_user_group`
--

INSERT INTO `zfwx_user_group` (`id`, `name`, `diynum`, `connectnum`, `iscopyright`, `activitynum`, `price`, `statistics_user`, `create_card_num`, `wechat_card_num`, `status`) VALUES
...
--
-- 导出表中的数据 `zfwx_weather`
--

INSERT INTO `zfwx_weather` (`id`, `code`, `name`) VALUES
(1, '101010100', '北京'),
(2, '101010200', '海淀'),
(3, '101010400', '顺义'),
(4, '101010500', '怀柔'),
